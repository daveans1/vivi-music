...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            com.music.vivi.constants.GithubConfig.NIGHTLY_DOWNLOAD_URL
        } else {
            "https://github.com/${com.music.vivi.constants.GithubConfig.REPO_OWNER}/${com.music.vivi.constants.GithubConfig.REPO_NAME}/releases/download/$versionName/vivi.apk"
        }
